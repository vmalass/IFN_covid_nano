...
PC1_VT_gene_DE_NRvsR <- read.table("data/PC1_VT_gene_DE_NRvsR_mat1.3.txt")
PC1_VT_gene_DE_RvsRP <- read.table("data/PC1_VT_gene_DE_RvsRP_mat1.3.txt")
PC1_VT_IFN_geneset <- read.table("data/PC1_VT_IFN_geneset_mat1.3.txt")


PC1_VT1_gene_DE_NRvsR <- read.table("data/PC1_VT1_gene_DE_NRvsR_mat1.3.txt")
...
PC1_VT2_gene_DE_RvsRP <- read.table("data/PC1_VT2_gene_DE_RvsRP_mat1.3.txt")
