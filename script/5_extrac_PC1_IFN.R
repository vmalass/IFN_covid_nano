...
ggplot(mergeMetaAPC, aes(x = PC1, y = PC2, color = REPONSE)) +
  ...
  labs(title="PCA sur VT1 gene set IFN")
...
write.table(PC1_VT1, "/Users/victor/Documents/JM/NanoString/IFN_covid_nano/data/PC1_VT1.txt")
...
ggplot(mergeMetaAPC, aes(x = PC1, y = PC2, color = REPONSE)) +
  ...
  scale_color_manual(breaks = c("NR","R","RP","T"),
                     values = c("darkorange","cornflowerblue","brown3","chartreuse4"))+
  labs(title="PCA sur VT2 gene set IFN")
...
write.table(PC1_VT2, "/Users/victor/Documents/JM/NanoString/IFN_covid_nano/data/PC1_VT2.txt")
