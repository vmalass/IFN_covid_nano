...
# 3-creation du data------------------------------------------------------------
mat_DE_VT1<- mat_pat_clean[,match(gene_DE_NR_R_HVG_all_VT1$x, colnames(mat_pat_clean))] 
...
write.table(PC1_VT1, "data/PC1_VT1_gene_DE_NRvsR.txt")
...
all(rownames(PC1_VT1) == rownames(MataData_PCA))
PC1_VT1 <- cbind(PC1_VT1, MataData_PCA)
write.table(PC1_VT1, "data/PC1_VT_gene_DE_NRvsR.txt")
...
all(rownames(PC1_VT1) == rownames(MataData_PCA))
PC1_VT1 <- cbind(PC1_VT1, MataData_PCA)
write.table(PC1_VT1, "data/PC1_V1_gene_DE_NRvsR.txt")
