...
R = data.frame("1","3"  ,  "5" ,  "8"  ,"9",  "11","12","14", "16","17",  "19", "20" , "22" ,"23" ,"25",  "27" , "30" ,"31", "47" ,  "51",   "52", "54", "58","59",  "63")
R<- as_tibble(t(R))
R$classe <- rep("R", 25)
...
NR= data.frame("2" ,"13",  "49","50")
NR <- as_tibble(t(NR))
NR$classe = rep("NR",4)
colnames(NR) = c("numero_patient", "classe")
classe = rbind(NR, classe)

RP = data.frame( "4",  "6", "10", "15", "21", "26", "29","48", "60","61")
RP <- as_tibble(t(RP))
RP$classe = rep("RP",10)
colnames(RP) = c("numero_patient", "classe")
...
R = data.frame("1","3"  ,  "5"  ,"7",  "8"  , "9",  "11","12",   "14",  "16","17", "18", "19", "20" , "22" ,"23" ,"25",  "27" , "30" ,"31", "47" ,"51",  "52", "54", "58","59", "63")
R<- as_tibble(t(R))
R$classe <- rep("R", 27)
colnames(R)<- c("numero_patient", "classe")
...
R = data.frame("1","3"  ,  "5",   "7"  ,  "8"  ,"9",   "11","12",   "14",  "16", "17","18",  "19", "20" , "22" ,"23" ,"25",  "27" , "30" ,"31")
R<- as_tibble(t(R))
R$classe <- rep("R", 20)
colnames(R)<- c("numero_patient", "classe")
...
R = data.frame("1","3"  ,  "5"  ,"7","7",  "8"  ,"9", "11","12",   "14",  "16","17", "18", "18",  "19", "20" , "22" ,"23","25",  "27" , "30" ,"31")
R<- as_tibble(t(R))
R$classe <- rep("R", 22)
colnames(R)<- c("numero_patient", "classe")
