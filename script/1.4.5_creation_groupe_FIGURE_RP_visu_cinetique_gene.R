# Groupe visu RP gene cinetique pour figure papier
...
R = data.frame("1", "3", "5" , "6", "8", "9", "11", "12", "14", "16", "17", "20",
               "25", "27", "30", "31", "47",  "54", "58", "63", "48", "61", "60",
               "13", "49","50",  "2","22","51", "62","19", "23", "52", "59")
R<- as_tibble(t(R))
R$classe <- rep("R", 34)
...
# 5-Svg fichier ----------------------------------------------------------------
save(mat_pat_clean, file = "data/1.6_mat_pat_clean_FIGURE_RP.rds") #svg du data
