# Groupe R RP et NC pour figure papier
...
# 5-Svg fichier ----------------------------------------------------------------
save(mat_pat_clean, file = "data/1.5_mat_pat_clean_FIGURE_R_RP_NC.rds") #svg du data
load("data/1.5_mat_pat_clean_FIGURE_R_RP_NC.rds") #ouverture de la svg
