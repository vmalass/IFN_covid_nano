...
pheatmap(mat_DE_VT1_T_all, 
         ...
         fontsize_col = 11, 
         fontsize = 10, 
         annotation_colors = list(REPONSE = c(
           R = "gray50",
           RP = "#CB2027",
...
# write.xlsx(table_suple, file = "/Users/victor/Documents/JM/NanoString/Papier/Supplementary/Heatmap_VT1_data.xlsx", rowNames = T)
...
# write.xlsx(DE_VT1_T_all_gene, file = "/Users/victor/Documents/JM/NanoString/Papier/Supplementary/DE_VT1_T_all_gene.xlsx", rowNames = T)
# write.xlsx(VT1_T_all_gene, file = "/Users/victor/Documents/JM/NanoString/Papier/Supplementary/DE_VT1_T_all_gene_filter.xlsx", rowNames = T)
...
# write.xlsx(table_suple, file = "/Users/victor/Documents/JM/NanoString/Papier/Supplementary/Heatmap_VT2_data.xlsx", rowNames = T)


## 3.4 VT3 Visualisation------------------------------------------------------------
mat_VT1 <- mat_pat_clean[which(mat_pat_clean$real_time_point %in% "VT3"),]
mat_VT1 <- rbind(mat_pat_clean[which(mat_pat_clean$real_time_point %in% "T"),], mat_VT1)
mat_VT1<- arrange(mat_VT1,numero_patient) #ordo par n° pat
...
# write.xlsx(table_suple, file = "/Users/victor/Documents/JM/NanoString/Papier/Supplementary/Heatmap_VT3_data.xlsx", rowNames = T)

## 3.5 VT4 Visualisation------------------------------------------------------------
mat_VT1 <- mat_pat_clean[which(mat_pat_clean$real_time_point %in% "VT4"),]
mat_VT1 <- rbind(mat_pat_clean[which(mat_pat_clean$real_time_point %in% "T"),], mat_VT1)
mat_VT1<- arrange(mat_VT1,numero_patient) #ordo par n° pat
...
# write.xlsx(table_suple, file = "/Users/victor/Documents/JM/NanoString/Papier/Supplementary/Heatmap_VT4_data.xlsx", rowNames = T)
...
ggplot(PC1_VT1, aes(x =jours_prelevement , y = `SelectPCA$PC1`, color = REPONSE)) + #, shape = real_time_point, label = label
  ...
  scale_color_manual(breaks = c("R", "RP", "T"),
                     values = c("#F15854", "#882255", "chartreuse4")) +
  labs(title="PCA all time points with gene DE VT1vsT gene according to the day after onset of symptoms",
